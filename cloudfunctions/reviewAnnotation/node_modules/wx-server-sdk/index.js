...
function getAi(cloud) {
    return function ai(options) {
        const tcbInstance = cloud.isCloudInstance ? cloud.instance : cloud.getInstanceForEnv(utils_1.getEnvFromAPIConfig(options === null || options === void 0 ? void 0 : options.config, cloud === null || cloud === void 0 ? void 0 : cloud.config, 'ai'));
        return tcbInstance.ai();
    };
}
exports.default = getAi;


/***/ }),

/***/ "./src/api/ai/api/api.ts":
/*!*******************************!*\
  !*** ./src/api/ai/api/api.ts ***!
  \*******************************/
/*! no static exports found */
...
const ai_1 = __webpack_require__(/*! ./ai */ "./src/api/ai/api/ai.ts");
function getAPIs(cloud) {
    return {
        ai: ai_1.default(cloud),
    };
}
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.registerService = exports.AI_SERVICE_NAME = void 0;
const api_1 = __webpack_require__(/*! ./api/api */ "./src/api/ai/api/api.ts");
// import { init } from "@cloudbase/node-sdk"
exports.AI_SERVICE_NAME = 'ai';
function createAiService(cloud) {
    return {
        name: exports.AI_SERVICE_NAME,
        getAPIs: api_1.getAPIs.bind(null, cloud),
    };
}
function registerService(cloud) {
    cloud.registerService(createAiService(cloud));
}
...
const ai_1 = __webpack_require__(/*! ./ai */ "./src/api/ai/index.ts");
